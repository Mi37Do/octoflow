          ...
          <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
            ...
            <DialogPanel
              ...
              <DialogTitle as="h3" class="pixa-title truncate">
                {{ t('translation.options') }} : {{ useAdministration.focusedDepartement ?
...
function closeModal() {
  ...
  setTimeout(() => {
    useAdministration.focusedDepartement = null
  }, 300)
}
...
const deleteItem = () => {
  ...
  console.log(useAdministration.focusedDepartement.designation)
  console.log({
    open: true,
    designation: useAdministration.focusedDepartement.designation,
    id: useAdministration.focusedDepartement.id,
  })
