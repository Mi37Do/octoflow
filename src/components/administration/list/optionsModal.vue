          ...
          <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
            ...
            <DialogPanel
              ...
              <DialogTitle as="h3" class="pixa-title truncate">
                {{ t('translation.options') }} : {{ useProduct.focusedProduct ? useProduct.focusedProduct.designation :
                  ''
                }}
              </DialogTitle>
...
function closeModal() {
  ...
  setTimeout(() => {
    useProduct.focusedProduct = null
  }, 300)
}
...
const deleteItem = () => {
  ...
  console.log(useProduct.focusedProduct.designation)
  console.log({
    open: true,
    designation: useProduct.focusedProduct.designation,
    id: useProduct.focusedProduct.id,
  })
