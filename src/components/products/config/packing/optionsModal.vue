          ...
          <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
            ...
            <DialogPanel
              ...
              <DialogTitle as="h3" class="pixa-title truncate">
                {{ t('translation.options') }} : {{ useProduct.focusedPacking ? useProduct.focusedPacking.designation :
                  ''
                }}
              </DialogTitle>
...
function closeModal() {
  ...
  setTimeout(() => {
    useProduct.focusedPacking = null
  }, 300)
}
...
const deleteItem = () => {
  ...
  console.log(useProduct.focusedPacking.designation)
  console.log({
    open: true,
    designation: useProduct.focusedPacking.designation,
    id: useProduct.focusedPacking.id,
  })
