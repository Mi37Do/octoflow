          ...
          <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
            ...
            <DialogPanel
              ...
              <DialogTitle as="h3" class="pixa-title truncate">
                {{ t('translation.options') }} : {{ useProduct.focusedColor ? useProduct.focusedColor.designation : ''
                }}
              </DialogTitle>
...
const deleteItem = () => {
  ...
  console.log(useProduct.focusedColor.designation)
  console.log({
    open: true,
    designation: useProduct.focusedColor.designation,
    id: useProduct.focusedColor.id,
  })
